...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        configDefault.fileURL = configDefault.fileURL!.deletingLastPathComponent().appendingPathComponent("default.realm")
        ...
        if users.count == 0 {
            ...
            if loginUsers.count == 1 {
                ...
                config.fileURL = config.fileURL!.deletingLastPathComponent().appendingPathComponent("\(userNow).realm")
